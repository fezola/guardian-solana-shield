...
const HeroSection = () => {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-48 h-48 rounded-full bg-accent/5 blur-2xl animate-float" style={{ animationDelay: '2s' }} />
      
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-muted/30 backdrop-blur-sm border border-border/50 mb-8">
            <ShieldCheck className="w-5 h-5 text-primary mr-2" />
            <span className="text-sm text-muted-foreground">Bulletproof Security for Solana Wallets</span>
          </div>
          ...
          <div className="mt-16 p-4 bg-muted/30 backdrop-blur-sm border border-border/50 rounded-xl">
            <p className="text-sm text-muted-foreground mb-2">Compatible with major Solana wallets</p>
