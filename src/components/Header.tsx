  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-4 backdrop-blur-md bg-background/80 border-b border-border/50">
      <div className="container flex justify-between items-center">
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="absolute top-full left-0 right-0 bg-background border-b border-border/50 md:hidden py-4">
            <nav className="container flex flex-col gap-4">
              ...
              <Button className="w-full button-glow" onClick={toggleMenu}>
                Get Started
              </Button>
            </nav>
          </div>
